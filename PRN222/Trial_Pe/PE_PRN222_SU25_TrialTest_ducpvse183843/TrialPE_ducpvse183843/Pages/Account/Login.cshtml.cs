...
namespace TrialPE_ducpvse183843.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        private readonly LionAccountService _Lion;

        public LoginModel() => _Lion ??= new LionAccountService();
        ...
        {                        
            var userAccount = await _Lion.GetUserAccount(UserName, Password);
